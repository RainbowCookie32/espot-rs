// NOTE: This is the same code that got merged to egui on https://github.com/emilk/egui/pull/1013
//       I'm just putting it here until a new egui version is released with it, instead of depending on git.


use eframe::egui::{Response, Sense, Ui, Widget};
use eframe::egui::epaint::{emath::lerp, vec2, Pos2, Shape, Stroke};
